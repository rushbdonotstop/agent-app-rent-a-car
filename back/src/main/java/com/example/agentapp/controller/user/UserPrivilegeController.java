...
import com.example.agentapp.dto.user.UserPrivilegeDTO;
import com.example.agentapp.dto.user.UserPrivilegeRequestDTO;
import com.example.agentapp.model.Notification;
import com.example.agentapp.service.user.UserPrivilegeService;
...
public class UserPrivilegeController {
    ...
    public ResponseEntity<Notification> deleteUserPrivilege(@PathVariable Long id, @PathVariable String privilege) {
        try {
