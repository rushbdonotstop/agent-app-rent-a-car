package com.example.agentapp.service.review;
...
import com.example.agentapp.repository.review.ReviewRepository;
...
public class ReviewService {
    ...
    public List<Review> getByVehicleId(Long vehicleId) {
        return reviewRepository.findAllByVehicleIdAndStatus(vehicleId, ReviewStatus.APPROVED);
    }

    public List<Review> userPosted(Long vehicleId, Long userId) {
        return reviewRepository.findAllByVehicleIdAndUserIdAndStatusNot(vehicleId, userId, ReviewStatus.REJECTED);
    }
